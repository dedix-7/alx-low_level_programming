...
/**
 * elfcheck - checks if the file is an elf file
 * @e_ident: array containing he bytes of an elf file
 * Return: 1 if it is, 0 if it isnt't
 */
int elfcheck(unsigned char *e_ident)
{
 ...
 * it follows the format of readelf
